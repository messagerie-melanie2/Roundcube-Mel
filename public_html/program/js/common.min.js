...
function(){var b=new Function("try{var o=new ActiveXObject('Microsoft.XMLHTTP');return true;}catch(err){return false;}");return this.xmlhttp=window.XMLHttpRequest||"ActiveXObject"in window&&b()};this.set_html_class=function(){var b=" js";this.ie?b+=" ie ie"+parseInt(this.vendver):this.opera?b+=" opera":this.konq?b+=" konqueror":this.safari?b+=" chrome":this.chrome?b+=" chrome":this.mz&&(b+=" mozilla");this.iphone?b+=" iphone":this.ipad?b+=" ipad":this.webkit&&(b+=" webkit");this.mobile&&(b+=" mobile");
this.tablet&&(b+=" tablet");document.documentElement&&(document.documentElement.className+=b)}}
...
var rcube_parse_query=function(a){if(!a)return{};var b={},c,d=/([^&=]+)=?([^&]*)/g,e=/\+/g;for(a=a.replace(/\?/,"");c=d.exec(a);){var f=decodeURIComponent(c[1].replace(e," "));c=decodeURIComponent(c[2].replace(e," "));"[]"===f.substring(f.length-2)?(f=f.substring(0,f.length-2),(b[f]||(b[f]=[])).push(c)):b[f]=c}return b},Base64=function(){var a=function(b){for(var c=0,d="",e,f,g;c<b.length;)e=b.charCodeAt(c),128>e?(d+=String.fromCharCode(e),c++):191<e&&224>e?(f=b.charCodeAt(c+1),d+=String.fromCharCode((e&
31)<<6|f&63),c+=2):(f=b.charCodeAt(c+1),g=b.charCodeAt(c+2),d+=String.fromCharCode((e&15)<<12|(f&63)<<6|g&63),c+=3);return d};return{encode:function(b){b=b.replace(/\r\n/g,"\n");for(var c="",d=0;d<b.length;d++){var e=b.charCodeAt(d);128>e?c+=String.fromCharCode(e):(127<e&&2048>e?c+=String.fromCharCode(e>>6|192):(c+=String.fromCharCode(e>>12|224),c+=String.fromCharCode(e>>6&63|128)),c+=String.fromCharCode(e&63|128))}b=c;if("function"===typeof window.btoa)try{return btoa(b)}catch(n){}for(var f,g,h,
k=0,l="",m=b.length;k<m;)f=b.charCodeAt(k++),c=b.charCodeAt(k++),d=b.charCodeAt(k++),e=f>>2,f=(f&3)<<4|c>>4,g=(c&15)<<2|d>>6,h=d&63,isNaN(c)?g=h=64:isNaN(d)&&(h=64),l=l+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h);return l},decode:function(b){if("function"===
