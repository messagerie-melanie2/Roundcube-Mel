...
1:0);this.init_header();this.frame=this.list.parentNode;this.keyboard&&(rcube_event.add_listener({event:"keydown",object:this,method:"key_press"}),$(this.list).attr("tabindex","0").on("focus",function(e){a.focus(e)}))}this.parent_focus&&(this.list.parentNode.onclick=function(e){a.focus()});return this},init_row:function(a){a.uid=this.get_row_uid(a);if(a&&a.uid){var b=this,c=a.uid;this.rows[c]={uid:c,id:a.id,obj:a};$(a).data("uid",c).mousedown(function(e){return b.drag_row(e,this.uid)}).mouseup(function(e){return 1!=
e.which||b.drag_active?!0:b.click_row(e,this.uid)});if((bw.ie||bw.edge)&&bw.pointer)$(a).on("pointerdown",function(e){if("touch"==e.pointerType)return b.pointer_touch_start=(new Date).getTime(),!1}).on("pointerup",function(e){if("touch"==e.pointerType&&(new Date).getTime()-b.pointer_touch_start<=b.pointer_touch_time)return b.drag_row(e,this.uid),b.click_row(e,this.uid)});else bw.touch&&a.addEventListener&&(a.addEventListener("touchstart",function(e){1==e.touches.length&&(b.touchmoved=!1,b.drag_row(rcube_event.touchevent(e.touches[0]),
this.uid))},!1),a.addEventListener("touchend",function(e){1==e.changedTouches.length&&(b.touchmoved||b.click_row(rcube_event.touchevent(e.changedTouches[0]),this.uid)||e.preventDefault())},!1),a.addEventListener("touchmove",function(e){1==e.changedTouches.length&&(b.touchmoved=!0,b.drag_active&&e.preventDefault())},!1));if(this.aria_listbox){var d="l:"+a.id;$(a).attr("role","option").attr("aria-labelledby",d).find(this.col_tagname()).eq(this.subject_col).attr("id",d)}document.all&&(a.onselectstart=
...
rcube_event.get_mouse_pos(a),c=[],d=this;if(!this.drag_mouse_start||3>Math.abs(b.x-this.drag_mouse_start.x)&&3>Math.abs(b.y-this.drag_mouse_start.y))return!1;this.drag_start_pos={left:b.x,top:b.y};this.draglayer?this.draglayer.html(""):this.draglayer=$("<div>").attr("id","rcmdraglayer").css({position:"absolute",display:"none","z-index":2E3}).appendTo(document.body);$(this.row_tagname()+".selected",this.tbody).each(function(){var e=d.get_row_uid(this),f=d.rows[e];if(f&&!(-1<$.inArray(e,c))&&(c.push(e),
f.has_children&&!f.expanded&&$.each(d.row_children(e),function(){-1<$.inArray(this,c)||c.push(this)}),11<c.length))return!1});$.each(c,function(e,f){if(10<e)return d.draglayer.append("..."),!1;$("> "+d.col_tagname(),d.rows[f].obj).each(function(g,h){if(0>d.subject_col||0<=d.subject_col&&d.subject_col==g)if(h=$(h).clone(),$(h).find(".skip-on-drag").remove(),g=h.text())return g=$.trim(g),g=50<g.length?g.substring(0,50)+"...":g,d.draglayer.append($("<div>").text(g)),!1})});this.draglayer.show();this.drag_active=
