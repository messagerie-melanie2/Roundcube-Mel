...
window.rcmail&&rcmail.addEventListener("init",function(a){rcmail.register_command("plugin.markasjunk",rcmail_markasjunk,rcmail.env.uid);rcmail.message_list&&rcmail.message_list.addEventListener("select",function(b){rcmail.enable_command("plugin.markasjunk",0<b.get_selection().length)})});
