...
function newmail_notifier_basic(){var a=rcmail.is_framed()?window.parent:window,b=rcmail.assets_path("plugins/newmail_notifier");a.focus();var c=$('<link rel="shortcut icon">').attr("href",b+"/favicon.ico");a=$('link[rel="shortcut icon"]',a.document);rcmail.env.favicon_href||(rcmail.env.favicon_href=a.attr("href"));rcmail.env.favicon_changed=1;c.replaceAll(a);try{window.external.msIsSiteMode()&&window.external.msSiteModeSetIconOverlay(b+"/overlay.ico",rcmail.get_label("title","newmail_notifier"))}catch(e){}}
function newmail_notifier_sound(){var a=rcmail.assets_path("plugins/newmail_notifier/sound"),b=navigator.mimeTypes?navigator.mimeTypes["audio/mp3"]:{};a+=bw.ie||b&&b.enabledPlugin?".mp3":".wav";try{var c=$("<audio>").attr("src",a);c.get(0).play()}catch(e){c=$('<embed id="sound" src="'+a+'" hidden=true autostart=true loop=false />'),c.appendTo($("body")),window.setTimeout("$('#sound').remove()",5E3)}}
function newmail_notifier_desktop(a,b){var c=rcmail.env.newmail_notifier_timeout||10,e=rcmail.assets_path("plugins/newmail_notifier/mail.png"),f=function(){var d=new window.Notification(rcmail.get_label("title","newmail_notifier"),{dir:"auto",lang:"",body:a,tag:"newmail_notifier",icon:e});d.onclick=function(){this.close()};setTimeout(function(){d.close()},1E3*c)};try{return window.Notification.requestPermission(function(d){"granted"==d?f():"denied"==d&&b&&b()}),!0}catch(d){return!1}}
