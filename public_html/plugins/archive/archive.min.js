...
window.rcmail&&rcmail.addEventListener("init",function(a){rcmail.register_command("plugin.archive",rcmail_archive,rcmail.env.uid&&!rcmail_is_archive());rcmail.message_list&&rcmail.message_list.addEventListener("select",function(c){rcmail.enable_command("plugin.archive",0<c.get_selection().length&&!rcmail_is_archive())});var b;rcmail.env.archive_folder&&(b=rcmail.get_folder_li(rcmail.env.archive_folder,"",!0))&&$(b).addClass("archive")});
