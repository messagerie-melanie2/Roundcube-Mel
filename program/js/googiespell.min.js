...
"";!b&&this.main_controller&&this.appendIndicator(this.spell_span);this.error_links=[];this.ta_scroll_top=this.text_area.scrollTop;this.ignore=a;var c=$(this.text_area);if(""==c.val()||a)this.custom_no_spelling_error?this.custom_no_spelling_error(this):this.flashNoSpellingErrorState(),this.removeIndicator();else{var d="border-box"==$(c).css("box-sizing")?this.text_area.offsetHeight:$(c).height();this.createEditLayer(c.width(),d);this.createErrorWindow();$("body").append(this.error_window);this.main_controller&&
